...
export const LinearProgress = (_a) => {
    ...
    variant = value === undefined ? 'indeterminate' : 'determinate', color = 'secondary', style, theme, trackColor, animation = { duration: 2000 } } = _a, props = __rest(_a, ["value", "variant", "color", "style", "theme", "trackColor", "animation"]);
