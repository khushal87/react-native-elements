...
declare const ThemedImage: (import("react").FunctionComponent<Omit<import("react-native").ImageProps & {
...
} & Partial<import("../config").ThemeProps<ImageProps>>, keyof import("../config").ThemeProps<T>>> | import("react").ForwardRefExoticComponent<import("react-native").ImageProps & {
    Component?: typeof import("react").Component;
    onPress?(): void;
    onLongPress?(): void;
    ImageComponent?: typeof import("react").Component;
