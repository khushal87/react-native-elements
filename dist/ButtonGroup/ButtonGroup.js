    ...
    return (<View testID="RNE__ButtonGroupContainer" {...rest} style={StyleSheet.flatten([
      ...
      {buttons === null || buttons === void 0 ? void 0 : buttons.map((button, i) => {
            ...
            <Component testID="RNE__ButtonGroupItem" accessibilityState={{
                    disabled: isDisabled,
                }} activeOpacity={activeOpacity} setOpacityTo={setOpacityTo} onHideUnderlay={onHideUnderlay} onShowUnderlay={onShowUnderlay} underlayColor={underlayColor} disabled={isDisabled} onPress={() => {
                    if (selectMultiple) {
